...
class PDFMaker {
    ...
    static void generateInvoicePDF(SaleResponse sale) {
        ...
        try {
            ...
            LOGGER.info("start in: " + startDate);

            File file = new File(fileName);
            if(!file.exists()){

                LOGGER.info("starting creation invoice " + sale.getId());
                ...
                LOGGER.info("invoice already exists " + sale.getId());
            }
